...
pub(crate) fn parse_peg() -> parser::expression::SetOfRules {
  rules!(
         r#"_eol"# => and!(rep!(lit!(" "), 0), ref_rule!(r#"eol"#))
       , r#"_'"# => lit!("'")
       , r#"_""# => lit!("\"")
       ...
       , r#"_"# => rep!(or!(lit!(" "), ref_rule!(r#"eol"#)), 0)
       ...
       , r#"rule"# => and!(ref_rule!(r#"_"#), ref_rule!(r#"symbol"#), ref_rule!(r#"_"#), lit!("="), ref_rule!(r#"_"#), ref_rule!(r#"expr"#), ref_rule!(r#"_eol"#), ref_rule!(r#"_"#))
       , r#"_1"# => or!(lit!(" "), ref_rule!(r#"eol"#))
       , r#"grammar"# => rep!(ref_rule!(r#"rule"#), 1)
       , r#"or"# => and!(ref_rule!(r#"and"#), rep!(and!(ref_rule!(r#"_"#), lit!("/"), ref_rule!(r#"_"#), ref_rule!(r#"or"#)), 0))
       , r#"dot"# => lit!(".")
       , r#"and"# => and!(ref_rule!(r#"rep_or_neg"#), rep!(and!(ref_rule!(r#"_1"#), ref_rule!(r#"_"#), not!(and!(ref_rule!(r#"symbol"#), ref_rule!(r#"_"#), lit!("="))), ref_rule!(r#"and"#)), 0))
